              ...
              function b(b, c) {
                ...
                for (d = 0; 2 > d; d++) {
                  for (y[d] = !0, f.value(d), e = 0; c.length > e && y[d]; e++)
                    (g = c[e]),
                      g.matchCondition &&
                        (y[d] = y[d] && g.matchCondition(null, a));
              ...
              for (
                ...
                if ((c = a.frames[k].find(this.selector, null, t)).length > 0) {
                  for (o = !0, l = 0; c.length > l; l++) {
                    for (
                      d = c[l].rule, g = c[l].path, n = !1, m = 0;
                      a.frames.length > m;
                      m++
                    )
                      if (
                        !(d instanceof e) &&
                        d === (a.frames[m].originalRuleset || a.frames[m])
                      ) {
                        n = !0;
                        break;
                      }
                  ...
                  for (l = 0; x.length > l; l++)
                    if (((p = x[l].group), p === A || p === q))
                      try {
                        (d = x[l].mixin),
                          d instanceof e ||
                            ((s = d.originalRuleset || d),
                            (d = new e("", [], d.rules, null, !1)),
                            (d.originalRuleset = s)),
                          Array.prototype.push.apply(
                            v,
                            d.evalCall(a, u, this.important).rules
                          );
                      } catch (D) {
                        throw {
                          message: D.message,
